console.log("appcabin.js logbook cabin berhasil terhubung!");
//URL Apps Script
const WEB_APP_URL ="https://script.google.com/macros/s/AKfycbzdiGUrAkx7XOKLtY_lnr1NlcNZoaaBentHUtgGdcr6pW6Nxfv0XGL2HMYbXzWerCj7/exec";
...
async function kirimData(dataPemeriksaan){
    ...
    try{
        ...
        const dataKirim ={
            ...dataPemeriksaan,
            pdfBase64: pdfBase64,
            namaFile : "Logbook_Xray_Cabin.pdf"
        };
...
window.addEventListener("load", function () {
    ...
    .then(hasil => {
        console.log("Aktivitas Cabin berhasil dicatat:", hasil);
    })
    .catch(error => {
        console.error("Gagal mencatat aktivitas Cabin:", error);
    });
