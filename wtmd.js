...
//URL Apps Script
const WEB_APP_URL ="https://script.google.com/macros/s/AKfycbxrfkFmrmHE4xNPQX8czxoCePYvI7f_rDrW34Z_RGmtZA5f_y3EqwTiPbbzPTUj8AA5kg/exec";
...
async function kirimData(dataPemeriksaan){
    ...
    try{
        ...
        const dataKirim ={
            ...dataPemeriksaan,
            pdfBase64: pdfBase64,
            namaFile : "LOGBOOK_PEMERIKSAAN_WTMD.pdf"
        };
...
window.addEventListener("load", function () {
    ...
    fetch("https://script.google.com/macros/s/AKfycbx1uJw8LffWSSDZomAzMeddKumTqQlntW8sjgZ4zQk_gsE2r_Fpa9SZhTvmZO70PWlxpQ/exec", {
        ...
        body: JSON.stringify({
            ...
            nama: nama,
            role: role,
            logbook: "Pemeriksaan WTMD",
            aktivitas: "Mengakses"
        })
    })
    .then(response => response.json())
    .then(hasil => {
        console.log("Aktivitas WTMD berhasil dicatat:", hasil);
    })
    .catch(error => {
        console.error("Gagal mencatat aktivitas WTMD:", error);
    });
