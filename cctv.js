...
//URL Apps Script
const WEB_APP_URL ="https://script.google.com/macros/s/AKfycbwOCWzjiSGtmoik2lVUkMruglhxEkh1XTylw4BIE9gYdJuC38hY7WfrmB4MvMFXONYjVg/exec";
...
window.addEventListener("load", function () {
    ...
    fetch("https://script.google.com/macros/s/AKfycbx1uJw8LffWSSDZomAzMeddKumTqQlntW8sjgZ4zQk_gsE2r_Fpa9SZhTvmZO70PWlxpQ/exec", {
        ...
        body: JSON.stringify({
            ...
            nama: nama,
            role: role,
            logbook: "Pemeriksaan CCTV",
            aktivitas: "Mengakses"
        })
    })
    .then(response => response.json())
    .then(hasil => {
        console.log("Aktivitas CCTV berhasil dicatat:", hasil);
    })
    .catch(error => {
        console.error("Gagal mencatat aktivitas CCTV:", error);
    });
