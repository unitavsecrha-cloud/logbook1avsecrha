console.log("hhmd.js berhasil terhubung!");
//URL Apps Script
const WEB_APP_URL ="https://script.google.com/macros/s/AKfycbxBR6buyICTMzOz1wOpD0oyWzecwfqpIEyAQyq-0byVWmpdDNYxYbWBGlxOYV166LxllQ/exec";
...
async function kirimData(dataPemeriksaan){
    ...
    try{
        ...
        const dataKirim ={
            ...dataPemeriksaan,
            pdfBase64: pdfBase64,
            namaFile : "LOGBOOK_PEMERIKSAAN_HHMD.pdf"
        };
...
window.addEventListener("load", function () {
    ...
    fetch("https://script.google.com/macros/s/AKfycbx1uJw8LffWSSDZomAzMeddKumTqQlntW8sjgZ4zQk_gsE2r_Fpa9SZhTvmZO70PWlxpQ/exec", {
        ...
        body: JSON.stringify({
            ...
            nama: nama,
            role: role,
            logbook: "Pemeriksaan HHMD",
            aktivitas: "Mengakses"
        })
    })
    .then(response => response.json())
    .then(hasil => {
        console.log("Aktivitas HHMD berhasil dicatat:", hasil);
    })
    .catch(error => {
        console.error("Gagal mencatat aktivitas HHMD:", error);
    });
